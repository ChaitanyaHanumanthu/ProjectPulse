...
const {verifyAdminToken} = require("./middlewares/adminTokenVerify.middleware");              //admin Token middleware
const {verifySuperAdminToken} = require("./middlewares/superAadminTokenVerify.middleware");   //super Admin Token middleware
const { verifyGdoToken } = require("./middlewares/gdoTokenVerify.middleware");                // Gdo Token Middleware
const {verifyManagerToken} = require("./middlewares/managerTokenVerifiy.middleware");         // Manager Token Middleware
...
// assosiation between project and updates - one to many relationship
Project.Concerns = Project.hasMany(Concerns, {foreignKey: { name: "projectId" }});
